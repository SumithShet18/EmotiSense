...
class EmotiSenseFullModel(nn.Module):
    ...
    def __init__(self, text_model_name, audio_model_name, head_model_class,
        ...
        self.text_encoder = AutoModel.from_pretrained(text_model_name, attn_implementation="eager")
    ...
    def encode_text(self, input_ids, attention_mask):
        out = self.text_encoder(input_ids=input_ids, attention_mask=attention_mask, output_attentions=True)
        hidden = out.last_hidden_state
        self._last_text_attentions = out.attentions
    ...
    def forward(self, input_ids=None, attention_mask_text=None,
                input_values=None, attention_mask_audio=None, return_contributions=False):
        text_features = None
        audio_features = None
