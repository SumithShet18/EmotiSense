          ...
          {result && (
            ...
            >
              ...
              {result.transcription_warning && (
                ...
                >
                  <span className="text-amber-400 text-sm leading-5 shrink-0 mt-0.5 font-bold">!</span>
                  <p className="text-amber-300 text-[13px]">{result.transcription_warning}</p>
                </motion.div>
              )}
